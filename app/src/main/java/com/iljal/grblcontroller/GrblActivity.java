...
package com.iljal.grblcontroller;
...
import com.iljal.grblcontroller.databinding.ActivityMainBinding;
import com.iljal.grblcontroller.events.ConsoleMessageEvent;
import com.iljal.grblcontroller.events.GrblAlarmEvent;
import com.iljal.grblcontroller.events.GrblErrorEvent;
import com.iljal.grblcontroller.events.StreamingCompleteEvent;
import com.iljal.grblcontroller.events.StreamingStartedEvent;
import com.iljal.grblcontroller.events.UiToastEvent;
import com.iljal.grblcontroller.helpers.EnhancedSharedPreferences;
import com.iljal.grblcontroller.helpers.NotificationHelper;
import com.iljal.grblcontroller.helpers.ReaderViewPagerTransformer;
import com.iljal.grblcontroller.listeners.ConsoleLoggerListener;
import com.iljal.grblcontroller.listeners.FileSenderListener;
import com.iljal.grblcontroller.listeners.MachineStatusListener;
import com.iljal.grblcontroller.model.Constants;
import com.iljal.grblcontroller.service.FileStreamerIntentService;
import com.iljal.grblcontroller.service.GrblBluetoothSerialService;
import com.iljal.grblcontroller.ui.BaseFragment;
import com.iljal.grblcontroller.ui.GrblFragmentPagerAdapter;
import com.iljal.grblcontroller.util.GrblUtils;
...
public abstract class GrblActivity extends AppCompatActivity implements BaseFragment.OnFragmentInteractionListener{
    ...
    private boolean hasPaidVersion() {
        ...
        try {
            pm.getPackageInfo("com.iljal.grblcontroller.plus", PackageManager.GET_ACTIVITIES);
            return true;
